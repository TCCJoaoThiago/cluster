...
c.JupyterHub.bind_url = 'http://maquina_jupyterhub:15000/jupyterhub'
c.NotebookApp.default_url = 'jupyterhub'
...
c.JupyterHub.hub_ip = 'maquina_jupyterhub'
...
c.Spawner.env_keep = [
    'PATH', 'PYTHONPATH', 'SPARK_HOME', 'HADOOP_HOME', 'JAVA_HOME',
    'HADOOP_BIN_HOME', 'HADOOP_CONF_DIR', 'HADOOP_COMMON_HOME',
    'HADOOP_LIBEXEC_DIR', 'HADOOP_HDFS_HOME', 'HADOOP_MAPRED_HOME',
    'HADOOP_YARN_HOME', 'HADOOP_COMMON_LIB_NATIVE_DIR', 'HADOOP_CLASSPATH'
]
